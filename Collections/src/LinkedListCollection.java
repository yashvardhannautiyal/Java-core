...
public class LinkedListCollection {
    public static void main(String[] args) {
        ...
        for(int i = 0; i<l1.size(); i++){
            ...
            System.out.println("LinkedList 1: "+l1.get(i));
        }
        ...
        for(int i =0; i<l2.size();i++){
            System.out.println("LinkedList 2: " + l2.get(i));
        }
...
//        7. addLast() adds element at last of the linkedlist
        l1.addLast(667);
//        8. addFirst() adds element at first of the linked list
        l1.addFirst(334);
    }
}
